...
if __name__ == "__main__":
    ...
    pitch = featureInput.compute_f0(
        input_args.source, hps.data.sampling_rate, hps.data.hop_length
    )
    ...
    FeatureInput.save_wav(audio, "vi-svc_out.wav", hps.data.sampling_rate)
